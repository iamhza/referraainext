...
export default function CareThreadPage() {
  ...
  const providerName = referral?.providerName || 'Provider';
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              <Button variant="ghost" asChild className="gap-1 hover:bg-gray-100">
                <Link href={`/case-manager/referrals/${referralId}`}>
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-sm">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Communicate with the provider about this referral
              </CardDescription>
            </CardHeader>

...
import { Loader2, FileText, Calendar, User, Trash2, Edit, Clock, AlertCircle, Plus } from 'lucide-react';
...
export default function DraftsPage() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-10 px-6 animate-fade-in">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Draft Referrals</h1>
            <p className="text-gray-600">
              Continue working on your saved referral drafts or create a new one.
            </p>
          </div>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete the draft for "{draftToDelete?.clientName}"? 
              This action cannot be undone and you'll lose all progress on this referral.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
